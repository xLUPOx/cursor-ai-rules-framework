...
- **Doctrine File Selection Protocol:** Prioritize project-level rules (`.cursor/rules/`), fallback to global rules if lesson is truly universal. Update GLOBAL-RULES.mdc directly with operational lessons. This file (`retro.md`) contains retrospective process itself, not operational lessons.
